...
///
/// All errors also flow into ToastService as toasts — the pipeline is
/// about *aggregation*, the toast service is about *display*. The two
/// coexist; consumers pick whichever surface fits.
