...
void HoldingsTable::apply_theme() {
    ...
    const QString ss = QStringLiteral(
        ...
        "QLabel#holdingsTableFooterText { color:%7; font-family:%5; font-size:12px;"
        "  background:transparent; }"
        "QPushButton#holdingsTableShowAll { background:transparent; color:%8;"
        "  border:1px solid %3; font-family:%5; font-size:12px; font-weight:700;"
