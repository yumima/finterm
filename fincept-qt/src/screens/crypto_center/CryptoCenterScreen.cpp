...
void CryptoCenterScreen::apply_theme() {
    ...
    const QString ss = QStringLiteral(
        ...
        "QLabel#cryptoCenterBrand { color:%4; font-family:%5; font-size:12px;"
        "  font-weight:700; letter-spacing:1.5px; background:transparent; }"
        "QLabel#cryptoCenterSep { color:%6; font-family:%5; font-size:12px;"
        "  background:transparent; }"
        "QLabel#cryptoCenterRoute { color:%7; font-family:%5; font-size:12px;"
        "  font-weight:600; letter-spacing:1.2px; background:transparent; }"
        "QLabel#cryptoCenterHeaderStatusOff { color:%8; font-family:%5; font-size:12px;"
        "  font-weight:700; letter-spacing:1.2px; background:transparent; }"
        "QLabel#cryptoCenterHeaderStatusOn { color:%9; font-family:%5; font-size:12px;"
        "  font-weight:700; letter-spacing:1.2px; background:transparent; }"
        ...
        "QLabel#cryptoCenterPanelTitle { color:%4; font-family:%5; font-size:12px;"
        "  font-weight:700; letter-spacing:1.2px; background:transparent; }"
        "QLabel#cryptoCenterPanelStatus { color:%8; font-family:%5; font-size:12px;"
        "  font-weight:700; letter-spacing:1.2px; background:transparent; }"
        ...
        "  background:transparent; }"
        "QLabel#cryptoCenterCaptionAccent { color:%4; font-family:%5; font-size:12px;"
        "  font-weight:700; letter-spacing:1.5px; background:transparent; }"
        "QLabel#cryptoCenterSecurityText { color:%11; font-family:%5; font-size:12px;"
        "  background:transparent; }"
        ...
        "  font-family:%5; font-size:12px; font-weight:700; letter-spacing:1.4px;"
