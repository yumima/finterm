...
void HomeTab::apply_theme() {
    ...
    const QString ss = QStringLiteral(
        ...
        "QLabel#homeTabPanelTitle { color:%4; font-family:%5; font-size:12px;"
        "  font-weight:700; letter-spacing:1.2px; background:transparent; }"
        "QLabel#homeTabPanelStatus { color:%6; font-family:%5; font-size:12px;"
        "  font-weight:700; letter-spacing:1.2px; background:transparent; }"
        "QLabel#homeTabPanelStatusOk { color:%9; font-family:%5; font-size:12px;"
        "  font-weight:700; letter-spacing:1.2px; background:transparent; }"
        "QWidget#homeTabRow { background:transparent; border-bottom:1px solid %3; }"
        "QWidget#homeTabRow[isLast=\"true\"] { border-bottom:none; }"
        "QLabel#homeTabCaption { color:%7; font-family:%5; font-size:12px;"
        "  font-weight:700; letter-spacing:1.2px; background:transparent; }"
        ...
        "QLabel#homeTabErrorText { color:%11; font-family:%5; font-size:12px;"
        "  background:transparent; }"
        "QPushButton#homeTabButton { background:%10; color:%7; border:1px solid %3;"
        "  font-family:%5; font-size:12px; font-weight:700; letter-spacing:1px; padding:0 12px; }"
        ...
        "  font-family:%5; font-size:12px; font-weight:700; letter-spacing:1.2px;"
        "  padding:0 10px; }"
        ...
        "  border-color:%4; }"
        "QLabel#homeTabRoadmapBody { color:%7; font-family:%5; font-size:12px;"
        "  background:transparent; }"
    )
