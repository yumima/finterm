...
QWidget* CompanyDetailPanel::build_placeholder() {
    ...
    lbl->setStyleSheet(
        QString("color:%1; font-size:14px;").arg(colors::TEXT_SECONDARY()));
...
QWidget* CompanyDetailPanel::build_detail_view() {
    ...
    name_lbl_->setStyleSheet(
        QString("color:%1; font-size:24px; font-weight:700; background:transparent;")
            .arg(colors::AMBER()));
    ...
    ipo_header->setStyleSheet(
        QString("color:%1; font-size:13px; font-weight:700; letter-spacing:1px; background:transparent;")
    ...
    status_badge_->setStyleSheet("font-size:13px; font-weight:700; border-radius:4px; padding:3px 10px;");

    window_lbl_ = new QLabel;
    window_lbl_->setStyleSheet(
        QString("color:%1; font-size:13px; background:transparent;").arg(colors::TEXT_PRIMARY()));
    ...
    hdr->setStyleSheet(
        QString("QHeaderView::section { background:%1; color:%2; border:none;"
                "  border-bottom:2px solid %3; padding:4px 8px; font-size:13px; font-weight:700; }")
    ...
    desc_lbl_->setStyleSheet(
        QString("color:%1; font-size:13px; line-height:1.5; background:transparent;")
...
void CompanyDetailPanel::populate(const PrivateCompany& c) {
    ...
    status_badge_->setStyleSheet(
        QString("color:%1; font-size:13px; font-weight:700; background:%2;"
    ...
    for (const auto& ticker : tickers) {
        ...
        btn->setStyleSheet(
            QString("QPushButton { background:%1; color:%2; border:1px solid %3;"
                    "  border-radius:3px; padding:3px 10px; font-size:13px; font-weight:600; }"
...
void CompanyDetailPanel::rebuild_tags(const QStringList& tags) {
    ...
    for (const auto& tag : tags) {
        ...
        lbl->setStyleSheet(
            QString("color:%1; font-size:13px; background:rgba(107,114,128,0.2);"
...
QWidget* CompanyDetailPanel::make_metric_tile(const QString& label, const QString& value,
    ...
    lbl->setStyleSheet(
        QString("color:%1; font-size:13px; font-weight:700; letter-spacing:0.5px; background:transparent;")
            .arg(colors::TEXT_SECONDARY()));
