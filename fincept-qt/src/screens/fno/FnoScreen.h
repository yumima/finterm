...
//
// Top-level shell. Five sub-tabs hosted in a QStackedWidget; each sub-tab
// is lazy-constructed on first reveal (chain assembly + WS subscriptions
// for the OI sub-tab don't fire until the user navigates there).
//
// Sub-tabs: Chain, Builder, OI Analytics, Multi-Straddle, Screener.
// (Upstream's FII/DII tab is intentionally absent — pure-India regulatory
// flow data that finterm doesn't surface.)
